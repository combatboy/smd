package org.zywx.wbpalmstar.plugin.uexappmarket.http;
...
public class HSSLSocketFactory extends SSLSocketFactory {
	...
	public Socket createSocket(Socket socket, String host, int port,
		...
		javax.net.ssl.SSLSocketFactory socketfact = mSSLContext
				.getSocketFactory();
	...
	public Socket connectSocket(Socket sock, String host, int port,
		...
		return super.connectSocket(sock, host, port, localAddress, localPort,
				params);
	}
